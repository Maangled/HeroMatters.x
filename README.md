...
## Abstract Summary
Have you ever asked yourself what cryptocurrency would look like if it were mainstream? What if the biggest promises of crypto privacy and decentralization came true? Instead of abandoning the government, we could enhance it with a new level of transparancy and efficiency. 
We would coststantly be adding new avenues of wealth growth.
It would no longer be limited to the rich being able to buy and manipulate the markets. Anyone, anywhere would be able to pick up a laptop or a phone and start contributing.
...
It would not allow the tracking of our every move without our consent and it would focus on individual security first and foremost.
...
## Maangled Identification
Personal Profile with wallet integration that doubles as streaming platform (HeroProtagonist.dao)
...
## Maangled Voting Interface (communi.dao)
...
### AI Applications
![image](https://user-images.githubusercontent.com/108793241/180627576-72ea3ec3-3b00-44ca-ba87-bf5258620821.png)


## Mangled Studios
There’s a growing demand for a sense of communal rebuilding of our infrastructure. With the growth of sustainable energy to meet our informational streaming demands, we are unlocking the power of global decentralized networks were information from every machine is able to work together to create a harmonious environment. Cars will know to avoid each other, your house may run the dishwasher late in the night to avoid peak hours of electrical demand. Information may well be the root of our existence, the ultimate descriptor of interactions of energy in existence. Humans are the drivers of the creation of information. Naturally- as if by instinct - we study each other and the environment around us. We seek information to optimize the planet we inhabit and yet it seems like there is only more to learn. Even with all of our technological advancements we still have many people faced with the information that they may soon be living on the street. There is only like 3 things you absolutely need to survive: food, water, shelter. They’re called basic needs and all three of them need restructuring. Giant corporations gobbled up everything and made it addictive and harmful. Our water pipes are degrading sending lead and other heavy metals into our homes. Homes are so expensive, that they are incredibly hard to purchase especially for someone with student loans and/or a low starting salary. All of these issues could be solved with good legislation, but many of them seem to be getting worse. All of these issues can be solved with decentralized grass roots efforts. Efforts are being made to take pressure off the system, and there is an opportunity connect all of these efforts through a single pipeline. This pipeline starts by helping people get out of bad situations such as homelessness and toxic environments and puts them on the road to becoming home owners. By starting homes from modular trailer kits, these homes will not only be more affordable, but they allow for the rapid introduction of new technology. 
![image](https://user-images.githubusercontent.com/108793241/177522904-8493319a-1077-49e9-aec0-f597416e919d.png)
Homes built around the idea of an educational workspace allow for a greater personal autonomy and freedom to upgrade or downsize their space at any time. Each trailer would include a Visual AI System that would lock the users identity to encrypted quantum-proof blockchain technology. With their personal idenity, they would be able to access the entire log of their actions, and choose AI algorithms to quantify their efforts spent learning and contributing to society into quantifiable data. This data can be made public at the user's desgression through a clear-cut permission based trading system with complete transparancy showing the exact route of data collection.
###Experimental Renditions 
Experimental renditions can be pursued by people wanting to find a new way to invest in their education. Experimental conditions in a small space allows for precise control preventing cross-contaminations, plus with the modular systems in place, trailers would be able to link their resources.
